<form action="{{ route('fasilitas.picture', [$detail->id]) }}" enctype="multipart/form-data" method="POST" style="display:none">
    @csrf
    @method('patch')
...
<div class="col-md-4">
    <div class="card">
        ...
        <div class="card-body" id="collapseExample">
            ...
            <img src="{{ route('get.image', ['profile-pict', $detail->foto]) }}" class="img-fluid img-thumbnail" />
            </div>
        </div> 
    </div>
</div>
